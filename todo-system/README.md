...
Sistema web completo desenvolvido em PHP + MySQL, utilizando Bootstrap 5 para o layout e interface visual. O projeto permite autenticação de usuários com sessão e gerenciamento completo de tarefas (CRUD), seguindo os requisitos acadêmicos da atividade proposta.
